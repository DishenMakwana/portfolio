...
import {
  LayoutDashboard, Users, Table2, GitMerge,
  ChevronLeft, ChevronRight, TrendingUp, Repeat2, PieChart, CalendarDays
} from 'lucide-react';
...
export default function AppSidebar() {
  ...
  return (
    ...
    >
      ...
      <div className={`flex min-h-28 items-center gap-4 border-b border-slate-800/60 px-6 ${
        ...
        {!collapsed && (
          <div className="min-w-0">
            <div className="text-xl font-extrabold text-slate-100 leading-tight">Family</div>
